...
HKEY Reg_OpenKey(HKEY key, const wchar_t *path, dword access) {
...
bool Reg_GetData(HKEY key, const wchar_t *name, dword *ltype, CBuf *buf) {
    dword size;
    dword rz;
...
void Reg_GetString(HKEY pkey, const wchar_t *path, const wchar_t *name, std::wstring &str) {
    HKEY kkey;
    dword type;
...
std::wstring Reg_GetString(HKEY pkey, const wchar_t *path, const wchar_t *name, const wchar_t *) {
    std::wstring str;
